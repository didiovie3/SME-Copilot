 ...
 * Mobile-only Card
 */
const InventoryMobileCard = memo(({ 
  item, 
  onEdit, 
  onArchive, 
  isLoading, 
          ...
          <Tabs defaultValue="active" onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="active" className="m-0">
              <div className="sm:rounded-lg border-y sm:border overflow-hidden divide-y sm:divide-none">
                ...
                {/* Mobile View - Separate from Table structure */}
            ...
            <TabsContent value="archived" className="m-0">
              <div className="sm:rounded-lg border-y sm:border overflow-hidden divide-y sm:divide-none">
                ...
                <div className="md:hidden divide-y bg-background">
                  {filteredInventory.length === 0 ? (
                    <div className="p-10 text-center text-muted-foreground italic">Archive is empty.</div>
                  ) : (
                    filteredInventory.map((item) => (
                      <InventoryMobileCard 
                        key={item.id} 
